...
#define kMinHeigth 150.0

@interface SendComTableViewCell()<UITextViewDelegate>
@property (nonatomic, strong) UIView* bgView;
@property (nonatomic, strong) UIView* lineView;

@end
@implementation SendComTableViewCell
...
{
    SendComTableViewCell *cell = [self dequeueReusableCellWithIdentifier:cellId];
    
    if (cell == NULL) {
        cell = [[SendComTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellId];
