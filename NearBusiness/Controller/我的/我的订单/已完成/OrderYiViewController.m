...
@interface OrderYiViewController ()<UITableViewDataSource,UITableViewDelegate,OrderYi2TableViewCellDelegate>{
...
@implementation OrderYiViewController
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (0 == indexPath.row) {
        ...
        static NSString *cellIdentifier = @"OrderYi1TableViewCell";
        OrderYi1TableViewCell* cell0 = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
        if (!cell0) {
            cell0 = [[OrderYi1TableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
        }
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (0 == indexPath.row) {
        ...
        return [OrderYi1TableViewCell hyb_heightForTableView:_tableView config:^(UITableViewCell *sourceCell) {
            OrderYi1TableViewCell *cell = (OrderYi1TableViewCell *)sourceCell;
            // 配置数据
            [cell configCellWithModel:model];
        }];
    }
